          ...
          <Slider {...settings}>
            <div>
              <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                ...
                >
                  <h2 className="max-w-72">Я нашла своего врача</h2>
                  <p className="text-lg font-normal text-baseText dark:text-darktext dark:text-opacity-80 py-10 max-w-632">
                    Я очень долго искала врача на ведение беременности и была
                    так рада найти Гузель Кавиевну. Сама клиника комфортная,
                    удобно расположена и недалеко от центра! Спасибо большое за
                    такой опыт
                  </p>
