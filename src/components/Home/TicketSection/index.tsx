...
const TicketSection = () => {
  return (
    <>
      <section className="dark:bg-darklight md:pt-20 pt-10">
        <div className="container">
          <div className="bg-baseText dark:bg-darkmode relative md:mx-auto mx-0 overflow-hidden py-0 rounded-22 lg:-mb-48 dark:lg:-mb-48 ">
            <div className="flex flex-wrap items-center justify-center gap-20 md:p-10 p-5 ">
              <div className="md:text-start text-center">
                <p className="sm:text-4xl text-[28px] leading-[2.25rem] font-bold text-white lg:max-w-404 max-w-full pb-9">
                  Запишитесь на приём сегодня
                </p>
                <p className="sm:text-xl text-[14px] leading-[2.25rem]  text-white lg:max-w-404 max-w-full pb-9">
              ...
              {/* <div className="md:w-[50%] w-full md:block overflow-hidden rounded-14">
                <Image
