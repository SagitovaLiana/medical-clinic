          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16 items-center">
            ...
            >
              ...
              <p className="text-baseText dark:text-darktext dark:text-opacity-80 mb-6">
                В нашей клинике вы можете получить полный спектр
                косметологических услуг от опытных специалистов. Используем
                только современные препараты и методики, прошедшие клинические
                испытания и имеющие все необходимые сертификаты. Мы подбираем
                индивидуальную программу омоложения для каждой пациентки с
                учётом особенностей кожи, возраста и желаемого результата. Все
                процедуры проводятся с соблюдением высочайших стандартов
                безопасности и стерильности. Доверьте свою красоту
                профессионалам — и результат превзойдёт ожидания!
              </p>
          ...
          >
            <div className="bg-white dark:bg-darkmode rounded-2xl p-6 text-center shadow-lg border border-border">
              ...
              <p className="text-baseText dark:text-darktext text-sm">
                Без "эффекта маски", сохраняем природную красоту и
                индивидуальность
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-darkmode rounded-2xl p-6 text-center shadow-lg border border-border">
              ...
              <p className="text-baseText dark:text-darktext text-sm">
                Используем только сертифицированные препараты ведущих
                производителей
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-baseText dark:text-darktext">
                  Врач хирург, дерматовенеролог, косметолог. Более 3 лет опыта в
                  косметологии. Специализируется на естественном омоложении и
                  комплексном подходе к красоте и здоровью кожи.
                </p>
              </div>
            </div>
          </div>
