        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 bg-primary/10 py-2 rounded-full mb-6">
              ...
              <span className="text-primary font-medium text-sm">Современная технология</span>
            </div>
            ...
            <p className="text-baseText dark:text-darktext dark:text-opacity-80 mb-6">
              Если раньше это было большой проблемой, то сейчас их можно легко и быстро 
              удалить с помощью аппарата <span className="font-bold text-primary">«Zerts»</span>, 
              который генерирует высокочастотные электрические волны.
            </p>
        ...
        >
          <div className="bg-white dark:bg-darkmode rounded-2xl p-6 text-center shadow-lg border border-border">
            ...
            <p className="text-baseText dark:text-darktext text-sm">
              Высокочастотные волны воздействуют точечно, не вызывая болевых ощущений
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-baseText dark:text-darktext">
                Удаляет новообразования с многолетним опытом. Использует только современные 
                методики и аппараты экспертного класса. Индивидуальный подход к каждому пациенту, 
